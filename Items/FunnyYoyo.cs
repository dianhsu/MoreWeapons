...
namespace MoreWeapons.Items {
    internal class FunnyYoyo: ModItem {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Funny Yoyo"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
            DisplayName.AddTranslation((int)GameCulture.CultureName.Chinese, "滑稽悠悠球");
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<FunnyYoyoProjectile>();
		}
